...
internal class JwtTokenGenerator(IOptions<JwtOptions> jwtSettings)
{
    ...
    public string GenerateAccessToken(Participant user, IList<string> roles)
    {
        ...
        var tokenExpiration = DateTime.UtcNow.AddMinutes(_jwtOptions.AccessTokenExpirationInMinutes);
